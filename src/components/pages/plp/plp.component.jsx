...
import { Container, Row, Col, Dropdown, Form, Accordion, Card, Button } from "react-bootstrap";
                ...
                <Container fluid>
                    <Row className="mt-3">
                        ...
                        <Col md={12} lg={10} className="">
                            <Container className="products_list border-bg">
                                <div className="category-det">
                                    <span className="category-heading">DRY FRUITS & NUTS</span>
                                    <div className="clearfix">
                                        <span className="category-des">A variety of Dry Fruits & Nuts products are available now here. Look inside for great offers and free delivery</span>
                                    </div>
                                </div>
                                <Row className="m-2 justify-content-end plp-filters">
                                    <Col xs={6} md ={4} lg={1} className="sort_label">
                                        <span>Sort By:</span>
                                    </Col>
